...
begin
        ...
        // Limpar listagem...
        Frm_Produto.img_no_produto.Visible := false;
        ...
        if Frm_Produto.lv_produto.Items.Count = 0 then
                Frm_Produto.img_no_produto.Visible := true;
end;
...
begin
        ...
        dm.qry_produto.Active := false;
        dm.qry_produto.sql.Clear;
        dm.qry_produto.sql.Add('SELECT * FROM TAB_PEDIDO_ITEM WHERE COD_PRODUTO = :COD_PRODUTO');
        ...
        begin
                Frm_Principal.Exibir_Mensagem('ALERTA', 'ALERTA', 'Aviso',
                                              'Esse produto já está sendo usado em outro pedido',
